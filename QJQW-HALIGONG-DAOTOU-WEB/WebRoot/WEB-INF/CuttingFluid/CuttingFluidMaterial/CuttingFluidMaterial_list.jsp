...
<script type="text/javascript">
	...
	function onSearchKey(){
		var url = "<%=path%>/CuttingFluidMaterial/queryCuttingFluidMaterialList";
...
<body>	
<form action="CuttingFluidMaterial/toCuttingFluidApply" method="post" name="toApply" id="toApply">
...
<div class="content_box_table">
	    ...
	    <c:forEach items="${cuttingFluidMaterialList}" var="var" varStatus="vs">
	      <div class="each_list_wrap">
			...
			<span class="opera_wrap  skz_hide  skz_list4">
			  <span class="btn btn_xg" onclick="edit('${var.id_CuttingFluidMaterial}');">修改</span>
			  <span class="btn btn_sc" onclick="del('${var.id_CuttingFluidMaterial}');">删除</span>
			</span>					
			<div class="clear"></div>
			<!-- 展开详情   -->
			<div id="ulli_${var.id_CuttingFluidMaterial}" class="ulli" style="display: none;">
					...
					<div class="box_p">
					    <h4>图片</h4>
					    <p>
					      <c:forEach items="${var.PictureCuttingFluidMaterialList}" var="var1" varStatus="vs">
					        <img name='pictureCuttingFluids_img' width='100px' height='100px' src='<%=path%>/goods${var1.url_PictureCuttingFluid }' />
					        <a class="btn" onclick="onShowPdf('${var1.url_PictureCuttingFluid }');">预览</a>
					        <br/>
					      </c:forEach>
					    </p>
					</div>
					...
					<div class="box_p">
					  <h4>详细信息</h4>
					  <p>
						<c:forEach items="${var.InformDetailCuttingFluidMaterialList}" var="var1" varStatus="vs">
				      		<span name='informDetailCuttingFluidMaterials_img' >${var1.name_InformDetailCuttingFluid }</span>
				      		<a class="btn" onclick="onShowPdf('${var1.url_InformDetailCuttingFluid }');">预览</a>
		      				<br/>
		    			</c:forEach>
					  </p>
					</div>
					<div class="box_p">
					  <h4>应用实例</h4>
					  <p>
						<c:forEach items="${var.ApplicationCuttingFluidMaterialList}" var="var1" varStatus="vs">
				      		<span name='applicationMaterials_img' >${var1.name_ApplicationCuttingFluid }</span>
				      		<a class="btn" onclick="onShowPdf('${var1.url_ApplicationCuttingFluid }');">预览</a>
		      				<br/>
		    			</c:forEach>
					  </p>
					</div>
  ...
  <div class="page-header position-relative" style="vertical-align:top;padding-top:10px;padding-left:20px;">
	<div class="pagination">
	  <ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="CuttingFluidMaterial/queryCuttingFluidMaterialList"/>
	</div>
  </div>
</div>
