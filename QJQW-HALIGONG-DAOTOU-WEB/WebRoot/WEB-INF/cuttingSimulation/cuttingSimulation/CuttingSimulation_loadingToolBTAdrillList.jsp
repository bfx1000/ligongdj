	  			...
	  			<c:forEach items="${toolBTAdrillList}" var="var" varStatus="vs">	
					<div class="each_list_wrap"  >
						...
						<span class="opera_wrap  skz_hide  skz_list9">
							<span class="btn btn_xg" onclick="window.parent.opt('${var.NumberBTADrill}',3,'${var.TypeBTADrill == 1 ? '焊接钻头' : '可转位钻头'}');">选择</span>
						</span>
						<div class="clear"></div>	
...
<!-- 		  <a class="btn" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除" >批量删除</a> -->
		...
		<div class="pagination">
	  		<ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="CuttingSimulation/jzAll?deputy=3"/>
		</div>
	</div>
</div>
</body>
