...
<div class="content_box_table">
  <form action="CuttingSimulation/jzAll?deputy=2" method="post" name="Form" id="Form">
	    ...
	    <c:forEach items="${turningBladeList}" var="var" varStatus="vs">
	      <div class="each_list_wrap">
			...
			<span class="opera_wrap  skz_hide  skz_list9">
			  <span class="btn btn_xg" onclick="window.parent.opt('${var.NumberTurningBlade }',2,'${var.TypeBTADrill==1?'外圆切削':(var.TypeBTADrill==2?'内孔切削':(var.TypeBTADrill==3?'超硬刀具':(var.TypeBTADrill==4?'重型加工刀片':''))) }');">选择</span>
			</span>					
			<div class="clear"></div>
			<!-- 展开详情   -->
  ...
  <div class="page-header position-relative" style="vertical-align:top;padding-top:10px;padding-left:20px;">
	<div class="pagination">
	  <ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="CuttingSimulation/jzAll?deputy=2"/>
	</div>
  </div>
</div>
