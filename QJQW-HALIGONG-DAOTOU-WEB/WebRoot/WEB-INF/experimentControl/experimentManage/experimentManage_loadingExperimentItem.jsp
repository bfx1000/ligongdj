...
<head>
	...
	<script type="text/javascript">
		...
		function onSearchKey(){
			var url = "<%=path%>/experimentManage/jzExperimentMachine?deputy=2";
...
<div class="content_box_table">
	<form action="experimentManage/jzExperimentMachine?deputy=2" method="post" name="Form" id="Form">
	...
	<div class="search_wrap">
		...
		<div class="check_wrap">			
			...
			<span class="label_wrap"><input type="checkbox" />材料牌号</span>
			<span class="label_wrap"><input type="checkbox" />材料类别</span>
		</div>
    		...
    		<c:when test="${not empty ExperimentItem}">
	  			<c:forEach items="${ExperimentItem}" var="var" varStatus="vs">	
					<div class="each_list_wrap"  >
						...
						<span class="list_title skz_hide  skz_list0">零件名称：${var.nameExperimentPart }</span>
						<span class="skz_hide skz_list1" >零件编号：${var.numberExperimentPart }</span>
						<span class="skz_hide skz_list2" >零件类型：${var.typeExperimentPart }</span>
						<span class="skz_hide  skz_list3" style="display: none;">材料牌号：${var.numberMaterialExperimentPart}</span>
						<span class="skz_hide  skz_list4" style="display: none;">材料类别：${var.categoryMaterialExperimentPart}</span>
						<span class="skz_hide  skz_list5" style="display: none;">备注：${var.remarkExperimentPart}</span>
						<span class="opera_wrap  skz_hide  skz_list6">
							<span class="btn btn_xg" onclick="parent.window.opt('${var.numberExperimentPart}',2);">选择</span>
						</span>
						<div class="clear"></div>	
							...
							<!--<img src="images/dtcp_img1.png" class="img1" alt="哈理工刀头" title="哈理工刀头"/> -->
								<div class="box_u1">
									<ul class="ul1">
								  		...
								  		<li><span>零件类型</span><i>${var.typeExperimentPart } </i></li>
								  		
									</ul>
									<ul class="ul1">
								  		<li><span>备注</span><i>${var.remarkExperimentPart}</i></li>
								  		<li><span>材料牌号</span><i>${var.numberMaterialExperimentPart } </i></li>
								  		<li><span>材料类别</span><i>${var.categoryMaterialExperimentPart } </i></li>
									</ul>
									<div class="clear"></div>
							  	</div>
							</div>
	...
	<div class="clear"></div>
  	<div class="page-header position-relative" style="vertical-align:top;padding-top:10px;padding-left:20px;">
		<div class="pagination">
	  		<ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="experimentManage/jzExperimentMachine?deputy=2"/>
		</div>
	</div>
</div>
</body>
