...
<script type="text/javascript">
	...
	function onSearchKey(){
		var url = "<%=path%>/experimentManage/jzExperimentMachine?deputy=1";
...
<div class="content_box_table">
  <form action="experimentManage/jzExperimentMachine?deputy=1" method="post" name="Form" id="Form">
  ...
  <div class="page-header position-relative" style="vertical-align:top;padding-top:10px;padding-left:20px;">
	<div class="pagination">
	  <ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="experimentManage/jzExperimentMachine?deputy=1" />
	</div>
  </div>
</div>
