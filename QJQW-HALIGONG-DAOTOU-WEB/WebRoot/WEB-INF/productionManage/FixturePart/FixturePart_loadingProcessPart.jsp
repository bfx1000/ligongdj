...
<head>
	...
	<script type="text/javascript">
		...
		function onSearchKey(){
			var url = "<%=path%>/FixturePart/loading?deputy=2";
...
<div class="content_box_table">
	<form action="FixturePart/loading?deputy=2" method="post" name="Form" id="Form">
	  			...
	  			<c:forEach items="${ProcessPart}" var="var" varStatus="vs">	
					<div class="each_list_wrap"  >
						...
						<span class="opera_wrap  skz_hide  skz_list5">
							&nbsp;&nbsp; <span class="btn btn_xg" onclick="window.parent.opt('${var.NumberProcessPart}',2);">选择</span>
						</span>
						<div class="clear"></div>	
...
<!-- 		  <a class="btn" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除" >批量删除</a> -->
		...
		<div class="pagination">
	  		<ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="FixturePart/loading?deputy=2"/>
		</div>
	</div>
</div>
</body>
