...
<head>
	...
	<script type="text/javascript">
		...
		function onSearchKey(){
			var url = "<%=path%>/ManufacturePlan/ManufacturePlanList";
	...
	<script type="text/javascript">
		...
		//新增
		function add(){
			window.location.href='<%=path%>/ManufacturePlan/goAddManufacturePlan?id=';
		}
		
		
		//修改
		function edit(id){
			window.location.href='<%=path%>/ManufacturePlan/goAddManufacturePlan?id=' + id;
		}
		...
		//删除
		function del(id_ManufacturePlan){
			if(confirm("确定要删除吗?")){
				var url = "<%=path%>/ManufacturePlan/deleteManufacturePlanList?id_ManufacturePlan=" + id_ManufacturePlan;
				document.Form.action = url;
...
<div class="content_box_table">
	<form action="ManufacturePlan/ManufacturePlanList" method="post" name="Form" id="Form">
	  <div class="search_wrap">
	  	...
	  	<div class="search_input_wrap">
		  	...
		  	<span>设备型号<input name="DeviceManufPlan" tpye="text" value="${pd.DeviceManufPlan }" /></span>
		  	<div class="clear"></div>
		 </div>
	  			...
	  			<c:forEach items="${ManufacturePlan}" var="var" varStatus="vs">	
					<div class="each_list_wrap"  >
						...
						<span class="opera_wrap  skz_hide  skz_list5">
							<span class="btn btn_xg" onclick="edit('${var.id_ManufacturePlan}');">修改</span>
						    <span class="btn btn_sc" onclick="del('${var.id_ManufacturePlan}');">删除</span>
						</span>
						<div class="clear"></div>	
							...
							<div class="box_xiangxi_copy">
								...
								<br/>
									<ul class="ul1_copy">
								  		...
								  		<li><span>设备型号:</span><i>${var.DeviceManufPlan }&nbsp; </i></li>
...
<!-- 		  <a class="btn" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除" >批量删除</a> -->
		...
		<div class="pagination">
	  		<ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="ManufacturePlan/ManufacturePlanList"/>
		</div>
	</div>
</div>
</body>
