...
<head>
	...
	<script type="text/javascript">
		...
		function onSearchKey(){
			var url = "<%=path%>/ManufacturePlan/loading?deputy=1";
...
<div class="content_box_table">
	<form action="ManufacturePlan/loading?deputy=1" method="post" name="Form" id="Form">
	  			...
	  			<c:forEach items="${ProcessPart}" var="var" varStatus="vs">	
					<div class="each_list_wrap"  >
						...
						<span class="opera_wrap  skz_hide  skz_list5">
							&nbsp;&nbsp;<span class="btn btn_xg" onclick="window.parent.opt(1,'${var.NumberProcessPart}','${var.NameProcessPart}','${var.NumberMaterialProcessPart}','${var.CategoryMaterialProcessPart}');">选择</span>
						</span>
						<div class="clear"></div>	
...
<!-- 		  <a class="btn" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除" >批量删除</a> -->
		...
		<div class="pagination">
	  		<ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="ManufacturePlan/loading?deputy=1"/>
		</div>
	</div>
</div>
</body>
