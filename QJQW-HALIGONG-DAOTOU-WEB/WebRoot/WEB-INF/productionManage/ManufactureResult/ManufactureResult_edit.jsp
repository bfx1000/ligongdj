...
<script type="text/JavaScript">
	...
	function onSavePictureManufRSList(){
		 ...
		 formDate.append("PictureManufactureResult",$("#PictureManufRS").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/savePictureManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	          async: false,  
	          cache: false,  
	...
	function onSavePictureToolWearManufRSList(){
		 var formDate = new FormData();  
		 formDate.append("PictureManufactureResult",$("#PictureToolWearManufRS").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/savePictureManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	...
	function onSaveSurfaceRoughnessFileManufRSList(){
		var formDate = new FormData();
		formDate.append("FileManufactureResult",$("#SurfaceRoughnessFileManufRS").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/saveFileManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	          async: false,  
	          cache: false,  
	...
	function onSaveSurfaceHardnessFileManufRSList(){
		var formDate = new FormData();  
		formDate.append("FileManufactureResult",$("#SurfaceHardnessFileManufRS").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/saveFileManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	...
	function onSaveSurfaceStressFileManufRSList(){
		var formDate = new FormData();
		formDate.append("FileManufactureResult",$("#SurfaceStressFileManufRS").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/saveFileManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	...
	function onSaveSurfaceMorphologyFileManufRSList(){
		var formDate = new FormData();  
		formDate.append("FileManufactureResult",$("#SurfaceMorphologyFileManufRS").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/saveFileManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	...
	function onSaveChipShapeFileManufRSList(){
		var formDate = new FormData();  
		formDate.append("FileManufactureResult",$("#ChipShapeFileManufRS").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/saveFileManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	...
	function onSaveManufRSDefined1FileList(){
		var formDate = new FormData();
		formDate.append("FileManufactureResult",$("#ManufRSDefined1File").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/saveFileManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	...
	function onSaveManufRSDefined2FileList(){
		var formDate = new FormData();  
		formDate.append("FileManufactureResult",$("#ManufRSDefined2File").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/saveFileManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	...
	function onSaveManufRSDefined3FileList(){
		var formDate = new FormData();
		formDate.append("FileManufactureResult",$("#ManufRSDefined3File").get(0).files[0]);
	     $.ajax({  
	          url: '/ManufactureResult/saveFileManufactureResult' ,  
	          type: 'POST',  
	          data: formDate,  
	...
	//取消
	function onClose(){
		window.location.href='<%=path%>/ManufactureResult/ManufactureResultList';
	}
	...
	//加载各种信息
	function jz(){
		var html = '<iframe name="content_iframe" class="content_iframe" id="content_iframe" frameborder="0" src="/ManufactureResult/loading" style="width:100%;height:100%;"></iframe>';
		$("#div").html(html);
	}
	function close(){
		$("#div").html("");
	...
	function opt(){
		...
		$("#QuantityManufRS_userForm").val(arguments[1]);
...
<div class="content_box_text">
  <ul class="box_text">
    <form action="/ManufactureResult/saveManufactureResult" name="userForm" id="userForm" method="post">
	 ...
	 <input type="hidden" name="array_ManufRSDefined3File_name" id="array_ManufRSDefined3File_name_userForm" value=""/>
	  ...
	  <input type="hidden" name="id_ManufactureResult" id="id_ManufactureResult_userForm" value="${(ManufactureResult.id_ManufactureResult == null || ManufactureResult.id_ManufactureResult == '') ? 0 : ManufactureResult.id_ManufactureResult}"/>
	  ...
	  <li>
	    ...
	    <input name="NoManufRS" id="NoManufRS_userForm" type="text" value="${ManufactureResult.NoManufRS}" class="input"/>
	  </li>		
	  <li>
	    <span id="lititle">生产数量</span>
	    <input name="QuantityManufRS" id="QuantityManufRS_userForm" type="text" value="${ManufactureResult.QuantityManufRS}" class="input"  />
	  </li>
	  <li>
	    <span id="lititle">生产日期</span>
	    <input name="DateStartManufRS" id="DateStartManufRS_userForm" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"  type="text" value="${ManufactureResult.DateStartManufRS}" class="input"  />
	  </li>
	  <li>
	    <span id="lititle">完成日期</span>
	    <input name="DateFinishManufRS" id="DateFinishManufRS_userForm" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"  type="text" value="${ManufactureResult.DateFinishManufRS}" class="input"  />
	  </li>
	  <li>
	    <span id="lititle">备注</span>
	    <input name="RemarkManufRS" id="RemarkManufRS_userForm" type="text" value="${ManufactureResult.RemarkManufRS}" class="input"  />
	  </li>
	  <li>&nbsp;</li>
	  <li>
	  ...
	  <li>
	    ...
	    <input name="PartNoManufRS" id="PartNoManufRS_userForm" type="text" value="${ManufactureResult.PartNoManufRS}" class="input"  />
	  </li>
	  
	  <li>
	    <span id="lititle">零件名称</span>
	    <input name="NameManufRS" id="NameManufRS_userForm" type="text" value="${ManufactureResult.NameManufRS}" class="input"  />
	  </li>
	  
	  <li>
	    <span id="lititle">材料牌号</span>
	    <input name="NumberMaterialManufRS" id="NumberMaterialManufRS_userForm" type="text" value="${ManufactureResult.NumberMaterialManufRS }" class="input"  />
	  </li>
	  
	  <li>
	    <span id="lititle">材料类别</span>
	    <input name="CategoryMaterialManufRS" id="CategoryMaterialManufRS_userForm" type="text" value="${ManufactureResult.CategoryMaterialManufRS }" class="input"  />
	  </li>
	  
	  <li>
	    <span id="lititle">设备编号</span>
	    <input name="DeviceManufRS" id="DeviceManufRS_userForm" type="text" value="${ManufactureResult.DeviceManufRS }" class="input"  />
	  </li>
	  
	  <li>
	    <span id="lititle">节点设备编号</span>
	    <input name="IDDeviceManufRS" id="IDDeviceManufRS_userForm" type="text" value="${ManufactureResult.IDDeviceManufRS}" class="input"  />
	  </li>
		...
		<div class="box_u1" id="box_clcs1" style="display:none">
			...
			<ul class="box_text">
			  ...
			  <li>
			    ...
			    <input name="NoProcessManufRS" id="NoProcessManufRS_userForm" type="text" value="${ManufactureResult.NoProcessManufRS }" class="input"  />
			  </li>
			  
			  <li>
			    <span id="lititle">工序名称</span>
			    <input name="NameProcessManufRS" id="NameProcessManufRS_userForm" type="text" value="${ManufactureResult.NameProcessManufRS}" class="input"  />
			  </li>
			  ...
			  <li>
			   ...
			   <li>
			    ...
			    <input name="NoProcessStepManufRS" id="NoProcessStepManufRS_userForm" type="text" value="${ManufactureResult.NoProcessStepManufRS}" class="input"  />
			  </li>
			  
			  <li>
			    <span id="lititle">工步名称</span>
			    <input name="NameProcessStepManufRS" id="NameProcessStepManufRS_userForm" type="text" value="${ManufactureResult.NameProcessStepManufRS}" class="input"  />
			  </li>
			  
			   <li>
			    <span id="lititle">加工类别</span>
			    <input name="MachiningTypeManufRS" id="MachiningTypeManufRS_userForm" type="text" value="${ManufactureResult.MachiningTypeManufRS }" class="input"  />
			  </li>
			  
			  <li>
			    <span id="lititle">加工级别</span>
			    <input name="MachiningLevelManufRS" id="MachiningLevelManufRS_userForm" type="text" value="${ManufactureResult.MachiningLevelManufRS }" class="input"  />
			  </li>
			  
			  <li>
			    <span id="lititle">切削液</span>
			    <input name="CuttingFluidManufRS" id="CuttingFluidManufRS_userForm" type="text" value="${ManufactureResult.CuttingFluidManufRS}" class="input" />
			  </li>		
			  <li>
			    <span id="lititle">切削速度</span>
			    <input name="CutterSpeedManufRS" id="CutterSpeedManufRS_userForm" type="text" value="${ManufactureResult.CutterSpeedManufRS}" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">主轴转速</span>
			    <input name="SpindleSpeedManufRS" id="SpindleSpeedManufRS_userForm" type="text" value="${ManufactureResult.SpindleSpeedManufRS}" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">每齿进给量</span>
			    <input name="FeedManufRS" id="FeedManufRS_userForm" type="text" value="${ManufactureResult.FeedManufRS}" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">切削深度</span>
			    <input name="CuttingDepthManufRS" id="CuttingDepthManufRS_userForm" type="text" value="${ManufactureResult.CuttingDepthManufRS}" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">切削宽度</span>
			    <input name="CuttingWidthManufRS" id="CuttingWidthManufRS_userForm" type="text" value="${ManufactureResult.CuttingWidthManufRS}" class="input" />
			  </li>		
			  <li>
			    <span id="lititle">进给速度</span>
			    <input name="FeedSpeedManufRS" id="FeedSpeedManufRS_userForm" type="text" value="${ManufactureResult.FeedSpeedManufRS}" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">刀柄</span>
			    <input name="ToolHolderManufRS" id="ToolHolderManufRS_userForm" type="text" value="${ManufactureResult.ToolHolderManufRS}" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">刀片</span>
			    <input name="ToolbladeManufRS" id="ToolbladeManufRS_userForm" type="text" value="${ManufactureResult.ToolbladeManufRS}" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">刀片/刀具材料</span>
			    <input name="ToolMaterialManufRS" id="ToolMaterialManufRS_userForm" type="text" value="${ManufactureResult.ToolMaterialManufRS}" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">刀具</span>
			    <input name="CutterManufRS" id="CutterManufRS_userForm" type="text" value="${ManufactureResult.CutterManufRS}" class="input" />
			  </li>
			  </form>
			  </ul>
		</div>
		...
		<div class="box_u1" id="box_clcs2" style="display:none">
			...
			<ul class="box_text">
			  <li>
			    ...
			    <input name="ToollifeManufRS" id="ToollifeManufRS_userForm" type="text" value="${ManufactureResult.ToollifeManufRS }" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">刀具磨损量</span>
			    <input name="ToolWearManufRS" id="ToolWearManufRS_userForm" type="text" value="${ManufactureResult.ToolWearManufRS}" class="input"  />
			  </li>
			   <li>
			    <span id="lititle">材料去除率</span>
			    <input name="RemovalRateManufRS" id="RemovalRateManufRS_userForm" type="text" value="${ManufactureResult.RemovalRateManufRS }" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">加工尺寸</span>
			    <input name="MachiningSize" id="MachiningSize_userForm" type="text" value="${ManufactureResult.MachiningSize}" class="input"  />
			  </li>
			   <li>
			    <span id="lititle">尺寸精度</span>
			    <input name="SizePrecision" id="SizePrecision_userForm" type="text" value="${ManufactureResult.SizePrecision }" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">加工时间</span>
			    <input name="MachiningTime" id="MachiningTime_userForm" type="text" value="${ManufactureResult.MachiningTime}" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">表面粗糙度</span>
			    <input name="SurfaceRoughnessManufRS" id="SurfaceRoughnessManufRS_userForm" type="text" value="${ManufactureResult.SurfaceRoughnessManufRS}" class="input"  />
			  </li>
			  <li class="block"> 
		 	  ...
		 	  <li>
			    ...
			    <input name="SurfaceHardnessManufRS" id="SurfaceHardnessManufRS_userForm" type="text" value="${ManufactureResult.SurfaceHardnessManufRS}" class="input"  />
			  </li>
			  <li class="block"> 
		 	  ...
		 	  <li>
			    ...
			    <input name="SurfaceStressManufRS" id="SurfaceStressManufRS_userForm" type="text" value="${ManufactureResult.SurfaceStressManufRS}" class="input"  />
			  </li>
			  <li class="block"> 
		 	  ...
		 	  <li>
			    ...
			    <input name="SurfaceMorphologyManufRS" id="SurfaceMorphologyManufRS_userForm" type="text" value="${ManufactureResult.SurfaceMorphologyManufRS}" class="input"  />
			  </li>
			  <li class="block"> 
		 	  ...
		 	  <li>
			    ...
			    <input name="ChipShapeManufRS" id="ChipShapeManufRS_userForm" type="text" value="${ManufactureResult.ChipShapeManufRS}" class="input"  />
			  </li>
			  <li class="block"> 
		...
		<div class="box_u1" id="box_clcs3" style="display:none">
			...
			<ul class="box_text">
			  <li>
			    ...
			    <input name="ManufRSDefined1" id="ManufRSDefined1_userForm" type="text" value="${ManufactureResult.ManufRSDefined1 }" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">结果1</span>
			    <input name="ManufRSDefined1Value" id="ManufRSDefined1Value_userForm" type="text" value="${ManufactureResult.ManufRSDefined1Value}" class="input"  />
			  </li>
			  <li class="block"> 
		 	  ...
		 	  <li>
			    ...
			    <input name="ManufRSDefined2" id="ManufRSDefined2_userForm" type="text" value="${ManufactureResult.ManufRSDefined2 }" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">结果2</span>
			    <input name="ManufRSDefined2Value" id="ManufRSDefined2Value_userForm" type="text" value="${ManufactureResult.ManufRSDefined2Value}" class="input"  />
			  </li>
			  <li class="block"> 
		 	  ...
		 	  <li>
			    ...
			    <input name="ManufRSDefined3" id="ManufRSDefined3_userForm" type="text" value="${ManufactureResult.ManufRSDefined3 }" class="input"  />
			  </li>
			  <li>
			    <span id="lititle">结果3</span>
			    <input name="ManufRSDefined3Value" id="ManufRSDefined3Value_userForm" type="text" value="${ManufactureResult.ManufRSDefined3Value}" class="input"  />
			  </li>
			  <li class="block"> 
