...
<head>
	...
	<script type="text/javascript">
		...
		function onSearchKey(){
			var url = "<%=path%>/ManufactureResult/ManufactureResultList";
	...
	<script type="text/javascript">
		//新增
		function add(){
			window.location.href='<%=path%>/ManufactureResult/goAddManufactureResult?id=';
		}
		//修改
		function edit(id){
			window.location.href='<%=path%>/ManufactureResult/goAddManufactureResult?id=' + id;
		}
		//展开折叠详细
		...
		//删除
		function del(id_ManufactureResult){
			if(confirm("确定要删除吗?")){
				var url = "<%=path%>/ManufactureResult/deleteManufactureResultList?id_ManufactureResult=" + id_ManufactureResult;
				document.Form.action = url;
...
<div class="content_box_table">
	<form action="ManufactureResult/ManufactureResultList" method="post" name="Form" id="Form">
	...
	<div class="content_wrap">
		...
		<c:choose>
    		<c:when test="${not empty ManufactureResult}">
	  			<c:forEach items="${ManufactureResult}" var="var" varStatus="vs">	
					<div class="each_list_wrap"  >
						<div class="onclick" onclick="onShowDetial(${var.id_ManufactureResult });"></div>
						...
						<span class="opera_wrap  skz_hide  skz_list7">
							<span class="btn btn_xg" onclick="edit('${var.id_ManufactureResult}');">修改</span>
						    <span class="btn btn_sc" onclick="del('${var.id_ManufactureResult}');">删除</span>
						</span>
						<div class="clear"></div>	
						
						<!-- 展开详情   -->
						<div id="ulli_${var.id_ManufactureResult}"  data-name="0"  class="ulli" style="display: none;">
							<div class="box_xiangxi_copy">
								...
								<br/>
									...
									<ul class="ul1_copy">
								  		<li><span>生产数量:</span><i>${var.QuantityManufRS } &nbsp;</i></li>
						...
						<div class="box_xiangxi zhedie">	
							<div class="box_zhedie">
									<span class="a_zhedie1" id = "zd${var.id_ManufactureResult }_1" onclick = "zd(${var.id_ManufactureResult },1);" style="display:block;">工艺信息</span>
									<span class="a_zhedie2" id = "zd1${var.id_ManufactureResult }_1" onclick = "zd1(${var.id_ManufactureResult },1);" style="display:none;">工艺信息</span>
								</div>
								 <div class="box_u1" id="box_clcs${var.id_ManufactureResult }_1" style="display:none"> 
								 	<div class="box_xiangxi_copy">
										<div class="box_u1">
										  	<ul class="ul1_copy">	
							...
							<div class="box_xiangxi zhedie">	
							<div class="box_zhedie">
									<span class="a_zhedie1" id = "zd${var.id_ManufactureResult }_2" onclick = "zd(${var.id_ManufactureResult },2);" style="display:block;">结果信息</span>
									<span class="a_zhedie2" id = "zd1${var.id_ManufactureResult }_2" onclick = "zd1(${var.id_ManufactureResult },2);" style="display:none;">结果信息</span>
								</div>
								 <div class="box_u1" id="box_clcs${var.id_ManufactureResult }_2" style="display:none"> 
								 	<div class="box_xiangxi_copy">
										<div class="box_u1">
										  	<ul class="ul1_copy">	
												...
												<div class="box_p">
												  	...
												  	<p>
												    	<c:forEach items="${var.SurfaceRoughnessFileManufRS}" var="var1" varStatus="vs">
												      		${var1.name_FileManufactureResult }
							...
							<div class="box_xiangxi zhedie">	
							<div class="box_zhedie">
									<span class="a_zhedie1" id = "zd${var.id_ManufactureResult }_3" onclick = "zd(${var.id_ManufactureResult },3);" style="display:block;">自定义结果</span>
									<span class="a_zhedie2" id = "zd1${var.id_ManufactureResult }_3" onclick = "zd1(${var.id_ManufactureResult },3);" style="display:none;">自定义结果</span>
								</div>
								 <div class="box_u1" id="box_clcs${var.id_ManufactureResult }_3" style="display:none"> 
								 	<div class="box_xiangxi">
										<div class="box_u1">
								 	<ul class="ul1">	
...
<!-- 		  <a class="btn" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除" >批量删除</a> -->
		...
		<div class="pagination">
	  		<ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="ManufactureResult/ManufactureResultList"/>
		</div>
	</div>
</div>
</body>
