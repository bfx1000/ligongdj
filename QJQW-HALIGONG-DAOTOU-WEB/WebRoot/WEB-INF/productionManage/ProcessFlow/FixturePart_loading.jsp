...
<head>
	...
	<script type="text/javascript">
		...
		function onSearchKey(gxId){
			var url = "<%=path%>/ProcessFlow/jzAll?deputy=2&gxId="+gxId;
...
<div class="content_box_table">
	<form action="/ProcessFlow/jzAll?deputy=2" method="post" name="Form" id="Form">
	  			...
	  			<c:forEach items="${FixturePart}" var="var" varStatus="vs">	
					<div class="each_list_wrap"  >
						...
						<span class="opera_wrap  skz_hide  skz_list5">
							&nbsp;&nbsp;<span class="btn btn_xg" onclick="window.parent.opt(2,${gxId },'${var.NumberFixturePart}');">选择</span>
						</span>
						<div class="clear"></div>	
...
<!-- 		  <a class="btn" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除" >批量删除</a> -->
		...
		<div class="pagination">
	  		<ff:page mhFrom="Form" showReSize="true"  field="page" onlyOneShow="true" showListNo="false" action="ProcessFlow/jzAll?deputy=2&gxId=${gxId}"/>
		</div>
	</div>
</div>
</body>
