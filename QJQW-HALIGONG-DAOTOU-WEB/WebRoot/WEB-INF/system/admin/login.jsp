...
<!-- 				 <img src="/resources/login/logo.png" alt="Logo" /> -->
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i><img height="37" src="/resources/login/user.png" /></i></span>
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i><img height="37" src="/resources/login/suo.png" /></i></span><input  type="password" name="password" id="password" placeholder="请输入密码" value="${password }" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-actions">
                	<div style="width:86%;padding-left:8%;">
	                    	...
	                    	<div style="float: left;"><i><img src="/resources/login/yan.png" /></i></div>
	                    	<div style="float: left;" class="codediv">
	                    	<input type="text" name="code" id="code" class="login_code" style="height:16px; padding-top:0px;"/></div>
      		...
      		<div class="controls">
               <div class="main_input_box">
                         	<font color="white"><span id="nameerr">Copyright © 哈尔滨祈福科技 2100</span></font>
               </div>
           </div>
   		</div>
   	</div>
     <div id="templatemo_banner_slide" class="container_wapper">
        <div class="camera_wrap camera_emboss" id="camera_slide">
            <div data-src="/resources/login/images/banner_1.jpg">
            </div>
            <div data-src="/resources/login/images/banner_2.jpg">
            </div>
            <div data-src="/resources/login/images/banner_3.jpg">
            </div>
            <div data-src="/resources/login/images/banner_4.jpg">
            </div>
            <div data-src="/resources/login/images/banner_5.jpg">
            </div>
            <div data-src="/resources/login/images/banner_6.jpg">
            </div>
            <div data-src="/resources/login/images/banner_7.jpg">
            </div>
            <div data-src="/resources/login/images/banner_8.jpg">
            </div>
            <div data-src="/resources/login/images/banner_9.jpg">
            </div>
            <div data-src="/resources/login/images/banner_10.jpg">
            </div>
        </div><!-- #camera_wrap_3 -->    
    </div>
	...
	<script type="text/javascript">
		...
		<script src="/resources/login/js/jquery.easing.1.3.js"></script>
	    <script src="/resources/login/js/jquery.mobile.customized.min.js"></script>
	    <script src="/resources/login/js/camera.min.js"></script>
	    <script src="/resources/login/js/templatemo_script.js"></script>
