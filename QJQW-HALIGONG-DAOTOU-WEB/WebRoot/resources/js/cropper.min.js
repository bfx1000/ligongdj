...
!function (a) {
  ...
  H = function (a, b) {
    ...
    return 'number' == typeof b && c.push(b),
    c.slice.apply(a, c)
  },
  I = function (a, b) {
    var c = H(arguments, 2);
  ...
  K.prototype = {
    ...
    load: function () {
      ...
      c && (this.replaced && (h.rotate = 0), this.defaults.checkImageOrigin && (f.prop('crossOrigin') || this.isCrossOriginURL(c)) && (i = ' crossOrigin', c = J(c)), this.$clone = b = a('<img' + i + ' src="' + c + '">'), b.one('load', function () {
    ...
    build: function () {
      ...
      d = this.$element,
      g = this.defaults;
      this.ready && (this.built && this.unbuild(), d.one(B, g.build), b = a.Event(B), d.trigger(b), b.isDefaultPrevented() || (this.$cropper = c = a(K.TEMPLATE), d.addClass(q), this.$clone.removeClass(r).prependTo(c), this.rotated || (this.$original = this.$clone.clone(), this.$original.addClass(q).prependTo(this.$cropper), this.originalImage = a.extend({
    ...
    addListeners: function () {
      ...
      this.$cropper.on(v, a.proxy(this.dragstart, this)).on(A, a.proxy(this.dblclick, this)),
      d.zoomable && this.$cropper.on(y, a.proxy(this.wheel, this)),
      d.multiple ? this.$cropper.on(w, a.proxy(this.dragmove, this)).on(x, a.proxy(this.dragend, this))  : c.on(w, this._dragmove = I(this.dragmove, this)).on(x, this._dragend = I(this.dragend, this)),
      b.on(z, this._resize = I(this.resize, this))
    },
    removeListeners: function () {
      var a = this.defaults;
      this.$element.off(D, a.dragstart).off(E, a.dragmove).off(F, a.dragend),
      this.$cropper.off(v, this.dragstart).off(A, this.dblclick),
      a.zoomable && this.$cropper.off(y, this.wheel),
      a.multiple ? this.$cropper.off(w, this.dragmove).off(x, this.dragend)  : c.off(w, this._dragmove).off(x, this._dragend),
    ...
    initPreview: function () {
      ...
      this.$viewer.html(b),
      this.$preview.html(b).find('img').css('cssText', 'min-width:0!important;min-height:0!important;max-width:none!important;max-height:none!important;')
    },
    initContainer: function () {
      var a = this.$container;
      this.container = {
        width: N(a.width(), 300),
        height: N(a.height(), 150)
      }
    },
    ...
    initImage: function () {
      ...
      b._width !== c.width || b._height !== c.height ? a.extend(b, d)  : (b = a.extend({
      }, d, b), this.replaced && (b.ratio = d.ratio)),
      this.image = b,
      this.renderImage()
    },
    renderImage: function (a) {
      ...
      b.left = M(N(b.left, b._width - b.width), 0),
      b.top = M(N(b.top, b._height - b.height), 0),
      this.$clone.css({
        width: b.width,
        height: b.height,
        marginLeft: b.left,
    ...
    initDragger: function () {
      ...
      c.minWidth = 0,
      c.minHeight = 0,
      d.aspectRatio ? (isFinite(d.maxWidth) ? (c.maxWidth = M(c.maxWidth, d.maxWidth * g), c.maxHeight = c.maxWidth / f)  : isFinite(d.maxHeight) && (c.maxHeight = M(c.maxHeight, d.maxHeight * g), c.maxWidth = c.maxHeight * f), d.minWidth > 0 ? (c.minWidth = N(0, d.minWidth * g), c.minHeight = c.minWidth / f)  : d.minHeight > 0 && (c.minHeight = N(0, d.minHeight * g), c.minWidth = c.minHeight * f))  : (c.maxWidth = M(c.maxWidth, d.maxWidth * g), c.maxHeight = M(c.maxHeight, d.maxHeight * g), c.minWidth = N(0, d.minWidth * g), c.minHeight = N(0, d.minHeight * g)),
      c.minWidth = M(c.maxWidth, c.minWidth),
      c.minHeight = M(c.maxHeight, c.minHeight),
      b = a.extend({
      }, c),
      b.height = c.height * d.autoCropArea,
      b.width = c.width * d.autoCropArea,
      b.left = 0,
      b.top = (e.height - b.height) / 2,
      b.oldLeft = c.oldLeft = c.left,
      b.oldTop = c.oldTop = c.top,
      this.autoCropDragger = b,
      this.defaultDragger = a.extend({
      }, c),
      this.dragger = c
    },
    renderDragger: function () {
      ...
      a.left = M(N(a.left, 0), b.width - a.width),
      a.top = M(N(a.top, 0), b.height - a.height),
      a.oldLeft = a.left,
      a.oldTop = a.top,
      this.dragger = a,
    ...
    reset: function (b) {
      this.cropped && (b && (this.defaults.data = {
      }), this.image = a.extend({
    ...
    transformData: function (b, c, d) {
      ...
      return a.each(b, function (a, b) {
        b = R(b),
        n.test(a) && !isNaN(b) && (f[a] = c ? d ? Math.round(b / e)  : b / e : b * e)
      }),
      f
    },
    ...
    dragging: function () {
      ...
      switch (s && (t.X = t.y * s, t.Y = t.x / s), b) {
        ...
        case 'zoom':
          ...
          }(c.width, c.height, O(this.startX - this.startX2), O(this.startY - this.startY2), O(this.endX - this.endX2), O(this.endY - this.endY2))), this.endX2 = this.startX2, this.endY2 = this.startY2);
          break;
        case 'crop':
  ...
  a.fn.cropper = function (b) {
    ...
    return this.each(function () {
      ...
      f = a(this),
      g = f.data('cropper');
      g || f.data('cropper', g = new K(this, b)),
