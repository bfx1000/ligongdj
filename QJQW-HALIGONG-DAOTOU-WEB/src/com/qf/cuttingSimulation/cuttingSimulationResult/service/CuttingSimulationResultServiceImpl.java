...
import com.qf.cuttingSimulation.cuttingSimulationResult.dao.CuttingSimulationResultMapping;
import com.qf.util.interceptor.PageHelper;
import com.qf.util.page.Page;

@Service("cuttingSimulationResultService")
public class CuttingSimulationResultServiceImpl implements CuttingSimulationResultService{

	
	@Resource
	private CuttingSimulationResultMapping mapper;
	...
	public void cleanCuttingSimulationResultFileById(Map para) {
		mapper.cleanCuttingSimulationResultFileById(para);
	}

	@Override
	public void saveCuttingSimulationResultFile(Map file) {
		mapper.saveCuttingSimulationResultFile(file);
	}
