...
@Controller
@RequestMapping("/designToolBTAdrillApp")
public class DesignToolBTAdrillAppController {
	 ...
	 * @param pageNo
	 * @param pageSize
	 * @param DesignNumberBTADrill
	 * @param DesignNameBTADrill
	 * @param DesignDiameterBTADrill
	 * @param DesignCompanyBTADrill
	 * @return
	 */
	
	@ResponseBody
	@RequestMapping(value = "queryDesignToolBTAdrillList",produces = "application/json; charset=utf-8")
	public String queryDesignToolBTAdrillList(int pageNo, int pageSize,
			 String DesignNumberBTADrill, String DesignNameBTADrill, String DesignDiameterBTADrill,
			 String DesignCompanyBTADrill ){
		...
		try{
			...
			pd.put("DesignNumberBTADrill", DesignNumberBTADrill);
			pd.put("DesignNameBTADrill", DesignNameBTADrill);
			pd.put("DesignDiameterBTADrill", DesignDiameterBTADrill);
			pd.put("DesignCompanyBTADrill", DesignCompanyBTADrill);
			
			page.setPd(pd);
			map	= designToolBTAdrillService.queryDesignToolBTAdrillList(page);//查询刀片列表
		...
		para.put("DesignDiameterBTADrill", DesignDiameterBTADrill);
	...
	@ResponseBody
	@RequestMapping(value="/goAddDesignToolBTAdrill" ,produces = "application/json; charset=utf-8")
	public String goAddDesignToolBTAdrill(String id)throws Exception{
		String json  = "";  
		Map resultmap = new HashMap();
		Map map	= null;
		...
		if(designToolBTAdrill != null){
			...
			resultmap.put("result", "1");
			resultmap.put("array_PictureDesignToolBTAdrill", array_PictureDesignToolBTAdrill);
			resultmap.put("array_InformDetailDesignToolBTAdrill", array_InformDetailDesignToolBTAdrill);
			resultmap.put("array_InformDetailDesignToolBTAdrill_name", array_InformDetailDesignToolBTAdrill_name);
			resultmap.put("array_PartDesignToolBTAdrill", array_PartDesignToolBTAdrill);
			resultmap.put("array_PartDesignToolBTAdrill_name", array_PartDesignToolBTAdrill_name);
			resultmap.put("array_pPart", array_pPart);
			resultmap.put("array_pPart_name", array_pPart_name);
			resultmap.put("array_cPart", array_cPart);
			resultmap.put("array_cPart_name", array_cPart_name);
			resultmap.put("array_ziPart", array_ziPart);
			resultmap.put("array_ziPart_name", array_ziPart_name);
			resultmap.put("array_onePart", array_onePart);
			resultmap.put("array_onePart_name", array_onePart_name);
			resultmap.put("array_twoPart", array_twoPart);
			resultmap.put("array_twoPart_name", array_twoPart_name);
			resultmap.put("array_bodyPart", array_bodyPart);
			resultmap.put("array_bodyPart_name", array_bodyPart_name);
			resultmap.put("array_sPart", array_sPart);
			resultmap.put("array_sPart_name", array_sPart_name);
			
		}
		
		resultmap.put("designToolBTAdrill", designToolBTAdrill);
	...
	@ResponseBody
	@RequestMapping(value = "/saveDesignToolBTAdrill", produces = "application/json; charset=utf-8")
	...
	public String savePictureExperimentItem(
			String PictureDesignToolBTAdrill ,String fileSuffix, String filename) throws Exception{
		...
		Map resultmap = new HashMap();
		String url = null;
		if(PictureDesignToolBTAdrill != null){
			String big_url = String.valueOf(Calendar.getInstance().getTimeInMillis());
			String filepath1 =  request.getSession().getServletContext().getRealPath("/goods/pictureDesignToolBTAdrill/");
			String fileName =  big_url + "." + fileSuffix;
			String filepath2 =  request.getSession().getServletContext().getRealPath("/goods/pictureDesignToolBTAdrill/" + big_url + "." + fileSuffix);
			ByteToFile.GenerateImage(PictureDesignToolBTAdrill,  filepath2);
	...
	@ResponseBody
	@RequestMapping(value="/saveInformDetailDesignToolBTAdrill", produces = "application/json; charset=utf-8")
	public String saveInformDetailDesignToolBTAdrill(
			String InformDetailDesignToolBTAdrill ,String fileSuffix, String filename) throws Exception{
		...
		String url = null;
		String name = null;
		if(InformDetailDesignToolBTAdrill != null){
			String big_url = String.valueOf(Calendar.getInstance().getTimeInMillis());
			String filepath1 =  request.getSession().getServletContext().getRealPath("/goods/informDetailDesignToolBTAdrill/");
			String fileName =  big_url + "." + fileSuffix;
			String filepath2 =  request.getSession().getServletContext().getRealPath("/goods/informDetailDesignToolBTAdrill/" + big_url + "." + fileSuffix);
			ByteToFile.GenerateImage(InformDetailDesignToolBTAdrill,  filepath2);
			url =  "/informDetailDesignToolBTAdrill/" + big_url + "." + fileSuffix;
			name = filename;
		}
	...
	@ResponseBody
	@RequestMapping(value="/savePartDesignToolBTAdrill", produces = "application/json; charset=utf-8")
	public String savePartDesignToolBTAdrill(
			String PartDesignToolBTAdrill ,String fileSuffix, String filename) throws Exception{
		...
		String url = null;
		String name = null;
		if(PartDesignToolBTAdrill != null){
			String big_url = String.valueOf(Calendar.getInstance().getTimeInMillis());
			String filepath1 =  request.getSession().getServletContext().getRealPath("/goods/partDesignToolBTAdrill/");
			String fileName =  big_url + "." + fileSuffix;
			String filepath2 =  request.getSession().getServletContext().getRealPath("/goods/partDesignToolBTAdrill/" + big_url + "." + fileSuffix);
			ByteToFile.GenerateImage(PartDesignToolBTAdrill,  filepath2);
			url = "/partDesignToolBTAdrill/" + big_url + "." + fileSuffix ;
			name = filename ;
		}
		resultmap.put("result", "1");
		resultmap.put("url", url);
	...
	@ResponseBody
	@RequestMapping(value="/savePartAllDesignToolBTAdrill", produces = "application/json; charset=utf-8")
	public String savePartAllDesignToolBTAdrill(
		...
		if(file != null){
			String big_url = String.valueOf(Calendar.getInstance().getTimeInMillis());
			String filepath1 =  request.getSession().getServletContext().getRealPath("/goods/partAllDesignToolBTAdrill/");
			String fileName =  big_url + "." + fileSuffix;
			String filepath2 =  request.getSession().getServletContext().getRealPath("/goods/partAllDesignToolBTAdrill/" + big_url + "." + fileSuffix);
			ByteToFile.GenerateImage(file,  filepath2);
			url = "/partAllDesignToolBTAdrill/" + big_url + "." + fileSuffix ;
			name = filename ;
		}
		resultmap.put("result", "1");
		resultmap.put("url", url);
	...
	@ResponseBody
	@RequestMapping(value = "/deleteDesignToolBTAdrill", produces = "application/json; charset=utf-8")
