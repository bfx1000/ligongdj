...
//		boolean d = templateURL.trim().indexOf(".XLSX") == -1;
	...
	{	
		...
		HSSFCell   cell   = row.getCell((short) beginCell);
		if(null == cell){
			cell = row.createCell((short) beginCell);
		}
		//设置存入内容为字符串
	...
	public static void main(String[] args) {
		...
		r.loadTemplate("C:\\Users\\Administrator\\Desktop\\1.xls");
		r.writeInTemplate("13855", 1, 1);
	}
