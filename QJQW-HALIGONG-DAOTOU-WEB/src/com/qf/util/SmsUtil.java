...
import com.qf.util.sms.MobClient;
...
//		sendSms2("15146639681","您的验证码是：1111。请不要把验证码泄露给其他人。");
	...
	public  String sendMsg(String phone) throws Exception{
		...
		try {
			...
			client.addParam("appkey", "7fd7eb5b7b40").addParam("phone", phone)
					.addParam("zone", "86");
	...
	public  boolean checkcode(String phone,String code) throws Exception{
		...
		String address = "https://web.sms.mob.com/sms/checkcode";
		MobClient client = null;
		String result="";
		try {
			client = new MobClient(address);
