...
public class MD5 {
	...
	public String getMD5ofStr(String inbuf) {
		...
		//匹配原数据库MD6加密方式
		String digestHexStrTemp = digestHexStr;
		String digestHexStrTempLeft = digestHexStrTemp.substring(0,16);
		String digestHexStrTempRight = digestHexStrTemp.substring(16,32);
		digestHexStr = digestHexStrTempRight + digestHexStrTempLeft;
